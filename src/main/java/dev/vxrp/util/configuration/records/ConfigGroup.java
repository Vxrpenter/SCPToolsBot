...
public record ConfigGroup(String token, boolean debug, boolean advanced_debug, String activity_type, String activity_content,
                          ...
                          String command_settings_template_descriptions, boolean cedmod_active, String cedmod_instance_url, String cedmod_api_key, String cedmod_master_banlist_id,
                          List<String> support_settings_roles_access_support_tickets, List<String> support_settings_roles_access_unban_tickets,
                          ...
                          int notice_of_departure_check_rate, boolean create_example_configuration, boolean only_load_certain_folder, List<String> only_load_folders) { }