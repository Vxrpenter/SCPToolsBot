...
public record ButtonsGroup(String paste_rules, String update_rules, String create_new_support_ticket,
                           ...
                           String revoke_notice_of_departure, String delete_notice_of_departure) {
}
